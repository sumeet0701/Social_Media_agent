...
class SocialMediaAgentException(Exception):
    ...
    def __init__(self, error_message:Exception, error_detail:sys):
        ...
        self.error_message = SocialMediaAgentException.error_message_detail(error_message, error_detail=error_detail)
    ...
    def __repr__(self):
        ...
        """
        return SocialMediaAgentException.__name__.__str__()